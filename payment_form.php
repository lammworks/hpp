...
<form id="payment_form" action="payment_confirmation.php" method="post">
    ...
    <input type="hidden" name="transaction_uuid" value="6495bd0e8b4b1">
    ...
    <input type="hidden" name="signed_date_time" value="2023-06-23T15:41:02Z">
    ...
    <input type="hidden" name="reference_number" value="1234abcd">
