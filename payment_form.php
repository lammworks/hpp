...
<form id="payment_form" action="payment_confirmation.php" method="post">
    ...
    <input type="hidden" name="unsigned_field_names" value="req_tax_amount,req_item_#_quantity,req_item_#_sku,req_item_#_tax_amount,req_item_#_unit_price,tax_indicator">
...
<span>req_item_#_quantity:</span><input type="text" name="req_item_#_quantity" size="25"><br/>
<span>req_item_#_sku:</span><input type="text" name="req_item_#_sku" size="25"><br/>
<span>req_item_#_tax_amount:</span><input type="text" name="req_item_#_tax_amount" size="25"><br/>
<span>req_item_#_unit_price:</span><input type="text" name="req_item_#_unit_price" size="25"><br/>
